...
function main() {
  ...
  let mainbedpicturenorth = new MainBedPictureNorth();
  let livingglass = new LivingGlass();
  let fencenorth = new FenceNorth();
  let fenceeast = new FenceEast();
  let fencewest = new FenceWest();
  ...
  let galleryframewest = new GalleryFrameWest();
  let galleryframenorth = new GalleryFrameNorth();
  let upperbathframe = new UpperBathFrame();
  let upperlivingframenorth = new UpperLivingFrameNorth();
  let upperlivingframeeast = new UpperLivingFrameEast();
  ...
  let drawables = [
    ...
    galleryframewest,
    galleryframenorth,
    upperlivingframeeast,
    upperlivingframenorth,
    mainbathframe,
    upperbathframe,
    mainbedframesouth,
    mainbedframenorth,
